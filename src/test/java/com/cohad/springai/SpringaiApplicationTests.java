...
import com.cohad.springai.controller.ChatController;
import com.cohad.springai.controller.PromptController;
...
class SpringaiApplicationTests {
	...
	void evaluateChatControllerResponseRelevancy() {
		...
		// When
		String aiResponse = chatController.getOpenAiChat(question);
	...
	public void evaluateHrPolicyAnswerWithRagContext() throws IOException {
		...
		// When
		String aiResponse = promptController.promptStuffing(question);
